...
| 시각 | 판정 | 사건 | 근거 |
|---|---|---|---|
| 2026-07-20T03:14:22Z | Passed | shell.aspx 생성 | MFT#12345 |
| 2026-07-20T03:22:15Z | Passed | svc_backup 계정 생성 | EVTX-SEC#40912 |
| 2026-07-20T03:22:19Z | Passed | svc_backup을 Administrators에 추가 | EVTX-SEC#40915 |

## 주의 필요 소견 (🟡 Warning - 분석가 교차 검증 요망)

다음 소견은 핵심 근거가 있으나 자동 검증만으로 확정할 수 없어 보고서에 경고와 함께 보존합니다.
...
자동 분석에서 확인하지 못한 아티팩트와 입력 서술은 아래 분석 범위에 명시합니다.
...
| evtx:PowerShell | 선별됐으나 산출물에 없음 — 04단계가 사유를 남기지 않았습니다 |
