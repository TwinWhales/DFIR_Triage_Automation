...
마지막 관문이 시나리오와 무관했다(``docs/limitations.md`` 3-2, ``limitations-log.md`` 4-2-1).
...
0건이라 모델에 한 건도 가지 않았다(``docs/limitations-log.md`` 6-7).
...
판별자를 찾기 전까지는 임시다(``docs/limitations.md`` 3-2).
"""
